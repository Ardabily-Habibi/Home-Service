...
import 'package:rincian/Kebersihan/elektronik.dart';
import 'package:rincian/Kebersihan/pilih_kebersihan.dart';
...
class _HomePageState extends State<HomePage> {
  List<dynamic> workers = [
    ...
    [
      'Michelle Baldwin',
      'Cleaner',
      'https://api.uifaces.co/our-content/donated/IPh6PTBx.jpg',
      4.6
    ],
    [
      'Brenon Kalu',
