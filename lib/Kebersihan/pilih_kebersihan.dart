...
class _CleaningPageState extends State<CleaningPage> {
  ...
  List<dynamic> _ruangan = [
    ...
    ['Kamar Mandi', 'https://img.icons8.com/color/2x/bath.png', Colors.blue, 1],
    ['Dapur', 'https://img.icons8.com/dusk/2x/kitchen.png', Colors.purple, 0],
    ['Kantor', 'https://img.icons8.com/color/2x/office.png', Colors.green, 0]
  ];

  List<int> _pilihRuangan = [];

  @override
  Widget build(BuildContext context) {
    return Scaffold(
        backgroundColor: Colors.white,
        floatingActionButton: _pilihRuangan.length > 0
            ...
            child: ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  return FadeAnimation(
                      (1.2 + index) / 4, room(_ruangan[index], index));
                }),
          ),
        ));
  }
  ...
  room(List room, int index) {
    return GestureDetector(
      onTap: () {
        setState(() {
          if (_pilihRuangan.contains(index))
            _pilihRuangan.remove(index);
          else
            _pilihRuangan.add(index);
        });
      },
      child: Container(
          ...
          decoration: BoxDecoration(
            ...
            color: _pilihRuangan.contains(index)
